...
f = open(prepare.path + 'results/result.csv' , 'w')
...
for classifier in experiment['experiment']:
	for feature in experiment['features']:
		...
		precision, recall, fscore, support, grid_search = training.test_model(prepare.path, classifier, feature)

		print('printing fscore', fscore)
		result_row = [[grid_search.best_score_, grid_search.best_params_, precision,recall,fscore,support, str(datetime.datetime.now()), classifier, feature]]
